...
public class SessionManagerFilter implements Filter{
    ...
    public void doFilter(HttpRequest var1, HttpResponse var2, FilterChain var3) throws IOException, ServletException {
        log.info("=> start SessionManagerFilter ");
        var2.setResponseContext(var2.getResponseContext() + " [start SessionManagerFilter] ");
        var3.doFilter(var1, var2);
        log.info("=> end SessionManagerFilter ");
        var2.setResponseContext(var2.getResponseContext() + " [end SessionManagerFilter] ");
    }
}
